...
public class UserTableShardingTest {
    ...
    public static final String SQL = "create table t_link_%d(\n" +
            ...
            "                         short_uri       varchar(8) character set utf8 collate utf8_bin null,\n" +
            ...
            "                         del_flag        tinyint(1)                     null comment '删除标识 0：未删除 1：已删除',  UNIQUE KEY `idx_unique_full_short_url` (`full_short_url`) USING BTREE\n" +
